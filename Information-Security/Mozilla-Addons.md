...
- [DKIM Verifier](https://addons.thunderbird.net/en-US/thunderbird/addon/dkim-verifier)
  ...
  *DomainKeys Identified Mail (DKIM) is a method which allows domains to sign e-mails. The add-on verifies these DKIM signatures and shows the result in the e-mail header.*
  
- [DS-BCC](https://addons.thunderbird.net/en-US/thunderbird/addon/ds-bcc)

  *Data protection extension, to avoid data mishaps with circular mails.*
- [PGPGeek](https://addons.thunderbird.net/en-US/thunderbird/addon/pgpgeek)
...
- [TORPEDO](https://addons.thunderbird.net/en-US/thunderbird/addon/torpedo-phishing-detection/) (german only)
