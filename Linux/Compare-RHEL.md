...
# changelog
# date          version    remark
# 2026-02-17    0.1       initial version as suggestes by *copilot*, no check, not for linting at all :-(
...
* **Rocky / Alma** → acceptable for regulated use **only with internal compensating controls**
...
* Regulators may ask:  
    *“Who is contractually responsible for security fixes?”*
...
> “Who signs the packages, and who is liable if compromised?”

You must answer procedurally, not contractually.
...
* **Most cost‑efficient but governance‑heavy:** **Rocky / Alma**
